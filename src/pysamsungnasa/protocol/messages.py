...
NASA_MESSAGES = [
    ...
    [0x200F, "ENUM_NM_NETWORK_POSITION_LAYER"],
    [0x2010, "ENUM_NM_NETWORK_TRACKING_STATE"],
    [0x2012, "ENUM_NM_PNP_STEP"],
    [0x2015, "ENUM_NM__"],
    [0x2017, "NASA_COMM_MICOM_LED"],
    ...
    [0x4077, "ENUM_IN_ROOM_TEMP_SENSOR_ZONE1"],
    [0x407B, "ENUM_IN___"],
    [0x407D, "ENUM_IN___"],
    ...
    [0x8031, "ENUM_OUT_LOAD_OIL_RETURN"],
    [0x8032, "ENUM_OUT___"],
    [0x8033, "ENUM_OUT___"],
    ...
    [0x803F, "ENUM_OUT___"],
    [0x8043, "ENUM_OUT_LOAD_OIL_RETURN2"],
    [0x8045, "ENUM_OUT___"],
    ...
    [0x8083, "ENUM_OUT_LOAD_OIL_RETURN3"],
    [0x808C, "ENUM_OUT___"],
    [0x808D, "ENUM_OUT___"],
    ...
    [0x80A8, "ENUM_OUT_LOAD_OIL_RETURN4"],
    [0x80A9, "ENUM_OUT___"],
    [0x80AA, "ENUM_OUT___"],
    [0x80AB, "ENUM_OUT___"],
    ...
    [0x80CE, "ENUM_OUT_LOAD_OIL_RETURN5"],
    ...
    [0x8224, "VAR_OUT_SENSOR_DISCHARGE4"],
    [0x8225, "VAR_OUT___"],
    ...
    [0x825A, "VAR_OUT___"],
    [0x825B, "VAR_OUT___"],
    [0x825C, "VAR_OUT_SENSOR_WATER_IN"],
    [0x825D, "VAR_OUT___"],
    ...
    [0x82B2, "VAR_OUT_SENSOR_WATER_OUT"],
    ...
    [0x82D1, "VAR_OUT_SENSOR_WATER_TEMP_EHS"],
    ...
    [0x82DC, "VAR_OUT_SENSOR_WATER_TEMP_EHS2"],
    [0x82DD, "VAR_OUT___"],
    ...
    [0x82F6, "VAR_OUT_SENSOR_SUCTION_OVERHEAT_TARGET"],
    ...
    [0x841A, "LVAR_OUT___"],
    [0x841F, "LVAR_OUT_ERROR_HISTORY_FOR_HASS"],
    [0x8601, "UNKNOWN"],
    [0x8608, "STR_OUT___"],
...
def nasa_message_name(message_number) -> str:
    for ns in NASA_MESSAGES:
        if ns[0] == message_number:
            return ns[1]
    else:
        raise ValueError("Message number not found")
