...
class TestGetAttributeEventSync:
    ...
    async def test_get_attribute_already_present(self, setup_device):
        ...
        result = await device.get_attribute(Message4203)
    ...
    async def test_get_attribute_waits_for_arrival(self, setup_device):
        ...
        task_get = asyncio.create_task(device.get_attribute(Message4203))
    ...
    async def test_get_attribute_timeout(self, setup_device, fast_timeout):
        ...
        with pytest.raises(TimeoutError):
            await device.get_attribute(Message9999)
    ...
    async def test_get_attribute_multiple_concurrent_calls(self, setup_device):
        ...
        result1_task = asyncio.create_task(device.get_attribute(Message4203))
        result2_task = asyncio.create_task(device.get_attribute(Message4203))
        result3_task = asyncio.create_task(device.get_attribute(Message4203))
    ...
    async def test_get_attribute_different_attributes(self, setup_device):
        ...
        result_4203_task = asyncio.create_task(device.get_attribute(Message4203))
        result_4001_task = asyncio.create_task(device.get_attribute(Message4001))
    ...
    async def test_get_attribute_rapid_sequential_calls(self, setup_device):
        ...
        result1 = await device.get_attribute(Message4203)

        # Second call should return immediately (attribute already present)
        result2 = await device.get_attribute(Message4203)
    ...
    async def test_event_signaling_on_handle_packet(self, setup_device):
        ...
        async def request_attributes():
            ...
            result1 = await device.get_attribute(Message4000)
            result2 = await device.get_attribute(Message4001)
    ...
    async def test_get_attribute_requires_read_forces_new_request(self, setup_device):
        ...
        result = await device.get_attribute(Message4203, requires_read=True)
        await packet_task
    ...
    async def test_get_attribute_requires_read_false_uses_cache(self, setup_device):
        ...
        result = await device.get_attribute(Message4203, requires_read=False)
    ...
    async def test_get_attribute_requires_read_with_concurrent_requests(self, setup_device):
        ...
        packet_task = asyncio.create_task(send_packets())
        result_cached = await device.get_attribute(Message4203, requires_read=False)
        result_fresh = await device.get_attribute(Message4203, requires_read=True)
        await packet_task
